...
[블로그] .jpg / .png / .gif 등 파일 업로드 방법
======================

# 1. 깃허브 블로그(Github blog) jpg, png, gif 삽입방법
## 1.1. 업로드를 위한  .jpg / .png / .gif 파일 준비
...
## 1.2. Github 레포지토리(Repository)의 Issue 발행
...
## 1.2. Github 레포지토리(Repository)의 Issue의 이미지 주소 가져오기

발행된 **Issue**를 이미지 주소로 접근하여 활용한다. 발행된 이슈의 이미지 주소를 확인하려면 해당 이슈를 클릭하고 파일을 우클릭, **이미지 주소 복사**하면 된다.  

이슈화면의 우측에 있는 ... 탭을 클릭하면 보이는 (copy link)는 해당 이슈의 이미지의 주소가 아닌 깃허브 주소이다.
